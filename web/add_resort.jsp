...
<div class="form-container">
    ...
    <form action="AddResortServlet" method="post" enctype="multipart/form-data">
    <input type="text" name="resort_name" placeholder="Resort Name" required>
    <textarea name="resort_description" placeholder="Resort Description" rows="4" required></textarea>
    <input type="number" name="price" placeholder="Price" required>
    <input type="file" name="resort_image" accept="image/*" required>
